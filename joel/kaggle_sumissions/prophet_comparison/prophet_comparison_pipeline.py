...
def get_paths(
    ...
    source_dir = source_submission_dir or (
        project_root / "joel" / "kaggle_sumissions" / "submission4"
    )
    out_dir = output_dir or (
        project_root / "joel" / "kaggle_sumissions" / "prophet_comparison"
    )
    ...
    return ComparisonPaths(
        ...
        daily_counts=source_dir / "order_shipped_ts.csv",
