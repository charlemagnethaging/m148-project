...
SUBMISSION_DIR = PROJECT_ROOT / "joel" / "kaggle_sumissions" / "submission5"
...
VOCAB_PATH = DATA_DIR / "rnn_event_vocab.json"
TRAIN_SEQUENCE_PATH = DATA_DIR / f"rnn_train_sequences_len{MAX_LEN}_n{MAX_TRAIN_SNAPSHOTS}.npz"
TEST_SEQUENCE_PATH = DATA_DIR / f"rnn_test_sequences_len{MAX_LEN}.npz"
MODEL_PATH = DATA_DIR / "rnn_gru_model.pt"
