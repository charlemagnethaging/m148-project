...
* **Integration**: We can create a script `m148-project.nosync/charlie/second-round/04_sequence_modelling.py` that reads the Parquet data, trains the PyTorch model, and saves the sequence embeddings or predictions.
